...
const FilterDropdown = ({ applyFilter, closeDropdown, filterDropdownPosition, activeFilters, handleApplyFilter, columnData }) => {
  ...
  return (
    <div ref={dropdownRef} className="filter-dropdown mygroup" style={{ position: 'absolute', top: filterDropdownPosition.top, left: filterDropdownPosition.left, zIndex: 9999}}>
